...
def test_child_env_is_built_not_inherited(monkeypatch):
    ...
    monkeypatch.setenv("COMPLIANCE_GATEWAY_SECRET", "super-secret")
...
def test_bootstrap_names_the_worktree_and_forbids_publication():
    text = cr.build_bootstrap(
        worktree="/wt", branch="client/compliance/abc", default_branch="main",
        project="compliance", memory_index="/mem/MEMORY_INDEX.md",
